...
def upgrade() -> None:
    ...
    try:
        ...
        add_column_if_not_exists('tasks', sa.Column('is_recurring', sa.Boolean(), nullable=False, server_default=sa.false()))
        add_column_if_not_exists('tasks', sa.Column('recurrence_pattern', sa.Enum(RecurrencePattern), nullable=True))
        add_column_if_not_exists('tasks', sa.Column('recurrence_interval', sa.Integer(), nullable=True))
        add_column_if_not_exists('tasks', sa.Column('recurrence_days_of_week', sa.String(20), nullable=True))
        add_column_if_not_exists('tasks', sa.Column('recurrence_day_of_month', sa.Integer(), nullable=True))
        add_column_if_not_exists('tasks', sa.Column('recurrence_month_of_year', sa.Integer(), nullable=True))
        add_column_if_not_exists('tasks', sa.Column('recurrence_end_date', sa.DateTime(timezone=True), nullable=True))
        add_column_if_not_exists('tasks', sa.Column('recurrence_count', sa.Integer(), nullable=True))
        add_column_if_not_exists('tasks', sa.Column('recurrence_parent_id', sa.String(), nullable=True))
        ...
        create_index_if_not_exists('ix_tasks_recurrence_parent_id', 'tasks', ['recurrence_parent_id'])
...
def downgrade() -> None:
    ...
    try:
        ...
        with op.batch_alter_table('tasks') as batch_op:
            try:
                batch_op.drop_constraint('fk_tasks_recurrence_parent_id', type_='foreignkey')
            except Exception as e:
