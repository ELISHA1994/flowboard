...
import { useCreateTagMutation } from '@/hooks/use-tags-query';
import { CreateTagRequest, TagsService } from '@/lib/api/tags';
      ...
      <DialogContent className="sm:max-w-[425px]">
        <form onSubmit={handleSubmit}>
          <DialogHeader>
            ...
            <DialogDescription>Add a new tag to label your tasks.</DialogDescription>
          </DialogHeader>

          {(createTag.error || error) && (
