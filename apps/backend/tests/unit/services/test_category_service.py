...
class TestCategoryService:
    ...
    def test_create_category_success(self):
        ...
        category_data = CategoryCreate(
            name="Work", description="Work related tasks", color="#FF5733", icon="💼"
        )
    ...
    def test_get_user_categories(self):
        ...
        result = CategoryService.get_user_categories(
            mock_db, "user-123", include_inactive=False
        )
    ...
    def test_update_category(self):
        ...
        existing_category = Category(
            id="cat-123", name="Work", description="Old description", color="#000000"
        )
        ...
        update_data = CategoryUpdate(
            name="Work Projects", description="Updated description", color="#FF5733"
        )

        # Call service
        result = CategoryService.update_category(
            mock_db, "cat-123", "user-123", update_data
        )
    ...
    def test_add_category_to_task(self):
        ...
        # Call service
        result = CategoryService.add_category_to_task(
            mock_db, "task-123", "cat-123", "user-123"
        )
    ...
    def test_remove_category_from_task(self):
        ...
        # Call service
        result = CategoryService.remove_category_from_task(
            mock_db, "task-123", "cat-123", "user-123"
        )
