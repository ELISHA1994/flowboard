...
from app.models.task import (TaskCreate, TaskResponse, TaskTimeUpdate,
                             TaskUpdate)
...
class TestEnhancedTaskCreate:
    ...
    def test_task_create_with_estimated_hours(self):
        ...
        task_data = {"title": "Time Estimated Task", "estimated_hours": 4.5}
        task = TaskCreate(**task_data)
    ...
    def test_task_create_with_position(self):
        ...
        task_data = {"title": "Positioned Task", "position": 5}
        task = TaskCreate(**task_data)
