...
class TestTagEndpoints:
    ...
    def test_create_tag(self, test_client: TestClient, test_user: User, auth_headers: dict):
    ...
    def test_create_tag_normalized_name(self, test_client: TestClient, test_user: User, auth_headers: dict):
    ...
    def test_create_bulk_tags(self, test_client: TestClient, test_user: User, auth_headers: dict):
    ...
    def test_list_tags(self, test_client: TestClient, test_user: User, auth_headers: dict, test_db: Session):
        """Test listing user tags"""
        # Create test tags
        tags = [
            Tag(id=str(uuid.uuid4()), name="bug", color="#FF0000", user_id=test_user.id),
            Tag(id=str(uuid.uuid4()), name="feature", color="#00FF00", user_id=test_user.id),
            Tag(id=str(uuid.uuid4()), name="urgent", color="#0000FF", user_id=test_user.id)
        ]
        for tag in tags:
            test_db.add(tag)
        test_db.commit()
    ...
    def test_get_popular_tags(self, test_client: TestClient, test_user: User, auth_headers: dict, test_db: Session):
        """Test getting popular tags"""
        # Create tags (in real scenario, these would have tasks associated)
        tags = [
            Tag(id=str(uuid.uuid4()), name="popular", color="#FF0000", user_id=test_user.id),
            Tag(id=str(uuid.uuid4()), name="common", color="#00FF00", user_id=test_user.id)
        ]
        for tag in tags:
            test_db.add(tag)
        test_db.commit()
    ...
    def test_get_tag(self, test_client: TestClient, test_user: User, auth_headers: dict, test_db: Session):
    ...
    def test_update_tag(self, test_client: TestClient, test_user: User, auth_headers: dict, test_db: Session):
        """Test updating a tag"""
        # Create test tag
        tag = Tag(
            id=str(uuid.uuid4()),
        ...
        response = test_client.put(f"/tags/{tag.id}", json=update_data, headers=auth_headers)
    ...
    def test_delete_tag(self, test_client: TestClient, test_user: User, auth_headers: dict, test_db: Session):
    ...
    def test_tag_isolation(self, test_client: TestClient, test_user: User, auth_headers: dict, test_db: Session):
    ...
    def test_tag_name_validation(self, test_client: TestClient, test_user: User, auth_headers: dict):
