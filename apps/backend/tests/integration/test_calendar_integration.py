...
from app.db.models import User, Task, CalendarIntegration
...
class TestCalendarIntegration:
    ...
    def test_create_duplicate_integration_fails(
        self, test_client: TestClient, test_user: User, auth_headers: dict, test_db: Session
    ):
    ...
    def test_get_calendar_integrations(
        ...
        response = test_client.get(
            "/calendar/integrations?active_only=false",
            headers=auth_headers
        )
    ...
    def test_delete_calendar_integration(
        ...
        # Verify deletion
        integration = test_db.query(CalendarIntegration).filter(
    ...
    def test_get_calendar_providers(
    ...
    def test_task_create_triggers_calendar_sync(
        self, mock_post, test_client: TestClient, test_user: User, 
