...
class TestAuthEdgeCases:
    ...
    def test_token_valid_but_user_deleted(
    ...
    def test_inactive_user_access(self, test_client: TestClient, test_db: Session):
        ...
        response = test_client.get(
            "/tasks/", headers={"Authorization": f"Bearer {access_token}"}
        )
    ...
    def test_user_deleted_between_requests(
        self, test_client: TestClient, test_db: Session
    ):
    ...
    def test_user_deactivated_between_requests(
        self, test_client: TestClient, test_db: Session
    ):
