...
class TestEnhancedTaskCreation:
    ...
    def test_create_task_with_invalid_dates(
        self, test_client: TestClient, test_user: User, auth_headers: dict
    ):
...
class TestTaskTimeTracking:
    ...
    def test_add_time_to_task(
        ...
        response = test_client.post(
            f"/tasks/{test_task.id}/time", json=time_data, headers=auth_headers
        )
    ...
    def test_add_time_invalid_amount(
        self,
        test_client: TestClient,
        test_user: User,
        test_task: Task,
...
class TestTaskStatusAndCompletion:
    ...
    def test_mark_task_done_sets_completed_at(
        self,
        test_client: TestClient,
        test_user: User,
        test_task: Task,
    ...
    def test_reopen_task_clears_completed_at(
        ...
        response = test_client.put(
            f"/tasks/{completed_task.id}", json=update_data, headers=auth_headers
        )
...
class TestTaskFiltering:
    ...
    def test_filter_by_due_date(
        ...
        response = test_client.get(
            f"/tasks/?due_before={due_before_str}", headers=auth_headers
        )
...
class TestTaskPositioning:
    ...
    def test_update_task_position(
        ...
        response = test_client.put(
            f"/tasks/{tasks[3].id}/position?new_position=1", headers=auth_headers
        )
