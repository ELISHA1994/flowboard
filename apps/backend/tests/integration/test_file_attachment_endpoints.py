...
from app.db.models import FileAttachment, Task, User
...
class TestFileUpload:
    ...
    @pytest.mark.skip(
        reason="TestClient has issues with multipart/form-data and auth headers"
    )
    ...
    def test_upload_to_nonexistent_task(
...
class TestFileList:
    ...
    def test_list_attachments_permission_denied(
        self, test_client: TestClient, second_user_token: str, test_task: Task
    ):
...
class TestFileDownload:
    ...
    def test_download_nonexistent_attachment(
        self, test_client: TestClient, test_user_token: str
    ):
