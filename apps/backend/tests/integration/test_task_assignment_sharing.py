...
from app.db.models import (Project, ProjectMember, ProjectRole, Task,
                           TaskShare, User)
...
class TestTaskAssignment:
    ...
    def test_update_task_assignment(
        ...
        update_data = {"assigned_to_id": second_user_id}
    ...
    def test_project_task_assignment_validation(
        self,
        test_client: TestClient,
        test_user_token: str,
        second_user_token: str,
        ...
        member_data = {"user_id": second_user_id, "role": "member"}
        test_client.post(
...
class TestTaskSharing:
    ...
    def test_update_existing_share(
        self,
        test_client: TestClient,
        test_user_token: str,
        second_user_token: str,
    ...
    def test_share_with_expiration(
        self,
        test_client: TestClient,
        test_user_token: str,
        second_user_token: str,
    ...
    def test_get_tasks_shared_with_me(
        self,
        test_client: TestClient,
        test_user_token: str,
        second_user_token: str,
    ...
    def test_share_permissions(
        ...
        assert "don't have permission" in error_resp.get(
            "detail", ""
        ) or "don't have permission" in str(error_resp)
