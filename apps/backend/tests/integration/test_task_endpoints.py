...
from tests.factories import TaskCreateFactory, TaskFactory, TaskUpdateFactory
...
class TestTaskCreate:
    ...
    def test_create_task_invalid_status(self, authenticated_client: TestClient):
        ...
        task_data = {"title": "Test Task", "status": "invalid_status"}
...
class TestTaskList:
    ...
    def test_list_tasks_filter_by_status(
        ...
        in_progress_task = TaskFactory.create(
            user_id=test_user.id, status=TaskStatus.IN_PROGRESS
        )
...
class TestTaskUpdate:
    ...
    def test_update_task_all_fields(
        self, authenticated_client: TestClient, test_task: Task, test_db: Session
    ):
    ...
    def test_update_task_partial(
        self, authenticated_client: TestClient, test_task: Task
    ):
