...
class ProjectInvitationCreate(BaseModel):
    ...
    invitee_email: str = Field(..., max_length=320, description="Email of the user to invite")
    role: ProjectRole = Field(ProjectRole.MEMBER, description="Role to assign to the invitee")
