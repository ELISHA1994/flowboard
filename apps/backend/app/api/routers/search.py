...
from app.db.models import SavedSearch, TaskStatus, TaskPriority
from app.models.task import TaskResponse
from app.models.search import (
    TaskSearchRequest, SavedSearchCreate, SavedSearchUpdate, SavedSearchResponse,
    BulkOperationRequest, BulkOperation, SearchSuggestionResponse
)
from app.services.search_service import SearchService, TaskSearchQuery, TaskSearchFilter
...
async def bulk_operation(
    ...
    if operation == BulkOperation.UPDATE_STATUS:
        ...
        result = BulkOperationsService.update_status(db, current_user.id, task_ids, TaskStatus(value))
        ...
        result = BulkOperationsService.update_priority(db, current_user.id, task_ids, TaskPriority(value))
    
    elif operation == BulkOperation.UPDATE_ASSIGNED_TO:
        result = BulkOperationsService.update_assigned_to(db, current_user.id, task_ids, value)
        ...
        result = BulkOperationsService.add_categories(db, current_user.id, task_ids, value)
        ...
        result = BulkOperationsService.remove_categories(db, current_user.id, task_ids, value)
        ...
        result = BulkOperationsService.move_to_project(db, current_user.id, task_ids, value)
