...
from app.db.models import (
    Task as TaskModel, Comment as CommentModel,
    User as UserModel
)
...
def format_comment_response(comment: CommentModel, include_replies: bool = True) -> dict:
...
async def create_comment(
    ...
    for mention in comment.mentions:
        NotificationService.notify_comment_mention(db, comment, mention.mentioned_user_id)
