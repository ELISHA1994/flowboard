...
class CategoryService:
    ...
    @staticmethod
    def create_category(
        db: Session, user_id: str, category: CategoryCreate
    ) -> Category:
    ...
    @staticmethod
    def update_category(
        db: Session, category_id: str, user_id: str, category_update: CategoryUpdate
    ) -> Optional[Category]:
        """Update a category"""
    ...
    def add_category_to_task(
        db: Session, task_id: str, category_id: str, user_id: str
    ) -> bool:
