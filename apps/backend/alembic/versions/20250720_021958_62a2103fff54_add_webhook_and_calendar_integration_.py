...
def upgrade() -> None:
    ...
    try:
        ...
        op.create_index(
            "ix_webhook_subscriptions_user_id", "webhook_subscriptions", ["user_id"]
        )
        op.create_index(
        ...
        op.create_index(
            "ix_calendar_integrations_user_id", "calendar_integrations", ["user_id"]
        )
        op.create_index(
            "ix_calendar_integrations_provider", "calendar_integrations", ["provider"]
        )
        ...
        op.create_index(
            "ix_task_calendar_sync_task_id", "task_calendar_sync", ["task_id"]
        )
        op.create_index(
            "ix_task_calendar_sync_calendar_integration_id",
            "task_calendar_sync",
            ["calendar_integration_id"],
        )
...
def downgrade() -> None:
    ...
    try:
        ...
        op.drop_index(
            "ix_calendar_integrations_provider", table_name="calendar_integrations"
        )
        op.drop_index(
            "ix_calendar_integrations_user_id", table_name="calendar_integrations"
        )
        ...
        op.drop_index(
            "ix_webhook_subscriptions_user_id", table_name="webhook_subscriptions"
        )
