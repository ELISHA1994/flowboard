...
def upgrade() -> None:
    ...
    try:
        ...
        # Create indexes
        op.create_index(
            op.f("ix_file_attachments_task_id"),
            "file_attachments",
            ["task_id"],
            unique=False,
        )
        op.create_index(
            op.f("ix_file_attachments_uploaded_by_id"),
            "file_attachments",
            ["uploaded_by_id"],
            unique=False,
        )
...
def downgrade() -> None:
    ...
    try:
        # Drop indexes
        op.drop_index(
            op.f("ix_file_attachments_uploaded_by_id"), table_name="file_attachments"
        )
        op.drop_index(
            op.f("ix_file_attachments_task_id"), table_name="file_attachments"
        )
