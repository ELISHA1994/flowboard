...
class BulkOperationsService:
    ...
    def update_status(
        ...
        accessible_tasks = BulkOperationsService.validate_task_access(db, user_id, task_ids)
    ...
    def remove_categories(
        ...
        for task in accessible_tasks:
            ...
            task.categories = [cat for cat in task.categories if cat.id not in category_ids]
