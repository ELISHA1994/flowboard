...
from app.db.models import Task, User, Comment, CommentMention


class TestCommentCreate:
    """Test comment creation functionality"""
    
    def test_create_comment_success(self, test_client: TestClient, test_user_token: str, test_task: Task):
    ...
    def test_create_comment_with_mention(self, test_client: TestClient, test_user_token: str, second_user_token: str, test_task: Task, test_db: Session):
    ...
    def test_create_reply_comment(self, test_client: TestClient, test_user_token: str, test_task: Task):
    ...
    def test_create_comment_unauthorized(self, test_client: TestClient, test_task: Task):
    ...
    def test_create_comment_on_nonexistent_task(self, test_client: TestClient, test_user_token: str):
    ...
    def test_create_comment_permission_denied(self, test_client: TestClient, second_user_token: str, test_task: Task):
...
class TestCommentRead:
    ...
    def test_get_task_comments(self, test_client: TestClient, test_user_token: str, test_task: Task):
        ...
        assert all(c["content"] in [d["content"] for d in comments_data] for c in comments)
    
    def test_get_comments_with_replies(self, test_client: TestClient, test_user_token: str, test_task: Task):
...
class TestCommentUpdate:
    ...
    def test_update_comment_success(self, test_client: TestClient, test_user_token: str, test_task: Task):
    ...
    def test_update_comment_with_new_mentions(self, test_client: TestClient, test_user_token: str, second_user_token: str, test_task: Task):
    ...
    def test_update_comment_permission_denied(self, test_client: TestClient, test_user_token: str, second_user_token: str, test_task: Task):
...
class TestCommentDelete:
    ...
    def test_delete_comment_success(self, test_client: TestClient, test_user_token: str, test_task: Task):
    ...
    def test_delete_comment_permission_denied(self, test_client: TestClient, test_user_token: str, second_user_token: str, test_task: Task):
...
class TestMentions:
    ...
    def test_get_my_mentions(self, test_client: TestClient, test_user_token: str, second_user_token: str, test_db: Session):
        ...
        test_client.post(
            ...
            json={"task_id": task_id, "shared_with_id": first_user_id, "permission": "view"},
            headers={"Authorization": f"Bearer {second_user_token}"}
        )
    ...
    def test_mentions_pagination(self, test_client: TestClient, test_user_token: str, second_user_token: str, test_db: Session):
