...
from app.db.models import Task, User, RecurrencePattern, TaskStatus


class TestCreateRecurringTask:
    """Test creating recurring tasks"""
    
    def test_create_daily_recurring_task(self, test_client: TestClient, test_user_token: str):
    ...
    def test_create_weekly_recurring_task(self, test_client: TestClient, test_user_token: str):
    ...
    def test_create_monthly_recurring_task(self, test_client: TestClient, test_user_token: str):
    ...
    def test_create_yearly_recurring_task(self, test_client: TestClient, test_user_token: str):
    ...
    def test_create_weekdays_recurring_task(self, test_client: TestClient, test_user_token: str):
    ...
    def test_create_recurring_task_invalid_config(self, test_client: TestClient, test_user_token: str):
...
class TestUpdateRecurringTask:
    ...
    def test_update_recurrence_pattern(self, test_client: TestClient, test_user_token: str):
...
class TestRecurringTaskInstances:
    ...
    def test_get_recurring_task_instances(self, test_client: TestClient, test_user_token: str, test_db: Session):
    ...
    def test_get_instances_non_recurring_task(self, test_client: TestClient, test_user_token: str, test_task: Task):
        ...
        assert "not a recurring task" in (error_data.get("detail", "") or error_data.get("message", ""))
    
    def test_get_instances_permission_denied(self, test_client: TestClient, test_user_token: str, second_user_token: str):
...
class TestNextOccurrence:
    ...
    def test_get_next_occurrence_daily(self, test_client: TestClient, test_user_token: str):
        ...
        assert result["next_occurrence"] in ["2025-01-03T10:00:00", "2025-01-03T10:00:00+00:00"]
    
    def test_get_next_occurrence_weekly(self, test_client: TestClient, test_user_token: str):
        ...
        assert result["next_occurrence"] in ["2025-01-08T10:00:00", "2025-01-08T10:00:00+00:00"]
    
    def test_get_next_occurrence_non_recurring(self, test_client: TestClient, test_user_token: str, test_task: Task):
...
class TestDeleteRecurrence:
    ...
    def test_delete_recurrence_keep_instances(self, test_client: TestClient, test_user_token: str):
    ...
    def test_delete_recurrence_with_instances(self, test_client: TestClient, test_user_token: str, test_db: Session):
        ...
        for i in range(3):
            occurrence_date = datetime.now(timezone.utc) + timedelta(days=i+1)
            RecurrenceService.create_recurring_instance(test_db, parent_task, occurrence_date)
        test_db.commit()
        ...
        instances = test_db.query(Task).filter(Task.recurrence_parent_id == task_id).all()
        assert len(instances) == 0
    
    def test_delete_recurrence_non_recurring(self, test_client: TestClient, test_user_token: str, test_task: Task):
